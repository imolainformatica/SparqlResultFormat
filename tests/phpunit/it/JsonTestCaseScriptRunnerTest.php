...
namespace SparqlResultFormat\Tests\Integration;

use PHPUnit\Framework\TestCase;
use SparqlResultFormat\Tests\Utils\UtilityFactory;
use SparqlResultFormat\Tests\ParserHtmlTestCaseProcessor;
use  SparqlResultFormat\Tests\JsonTestCaseFileHandler;
use SparqlResultFormat\Tests\ParserTestCaseProcessor;
...
class JsonTestCaseScriptRunnerTest extends JsonTestCaseScriptRunner {
	...
	protected function setUp() {
		...
		$this->parserTestCaseProcessor = new ParserTestCaseProcessor(null,null,null,
			//$this->getStore(),
